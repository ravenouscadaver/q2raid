...
static const std::initializer_list<field_t> entity_fields = {
	...
	FIELD_AUTO_NAMED("required_action", pathtarget),
	{ "raid_alert_emit", [](edict_t *e, const char *v) { RaidDirector_SetEntityEventField(e, "raid_alert_emit", v); } },
	{ "raid_alert_tag", [](edict_t *e, const char *v) { RaidDirector_SetEntityEventField(e, "raid_alert_tag", v); } },
	{ "raid_arrival_target", [](edict_t *e, const char *v) { RaidDirector_SetEntityEventField(e, "raid_arrival_target", v); } },
	{ "raid_arrival_tag", [](edict_t *e, const char *v) { RaidDirector_SetEntityEventField(e, "raid_arrival_tag", v); } },
	{ "raid_arrival_radius", [](edict_t *e, const char *v) { RaidDirector_SetEntityEventField(e, "raid_arrival_radius", v); } },
	{ "raid_arrival_emit", [](edict_t *e, const char *v) { RaidDirector_SetEntityEventField(e, "raid_arrival_emit", v); } },
#define RAID_LISTENER_FIELD(N, F) { "listen_" #N "_" #F, [](edict_t *e, const char *v) { RaidDirector_SetListenerField(e, N, #F, v); } }
	RAID_LISTENER_FIELD(1, event), RAID_LISTENER_FIELD(1, action), RAID_LISTENER_FIELD(1, source), RAID_LISTENER_FIELD(1, subject),
	RAID_LISTENER_FIELD(1, tag), RAID_LISTENER_FIELD(1, radius), RAID_LISTENER_FIELD(1, edge), RAID_LISTENER_FIELD(1, count),
	RAID_LISTENER_FIELD(1, window), RAID_LISTENER_FIELD(1, cooldown), RAID_LISTENER_FIELD(1, once), RAID_LISTENER_FIELD(1, consume),
	RAID_LISTENER_FIELD(1, dedupe), RAID_LISTENER_FIELD(1, emit),
	RAID_LISTENER_FIELD(2, event), RAID_LISTENER_FIELD(2, action), RAID_LISTENER_FIELD(2, source), RAID_LISTENER_FIELD(2, subject),
	RAID_LISTENER_FIELD(2, tag), RAID_LISTENER_FIELD(2, radius), RAID_LISTENER_FIELD(2, edge), RAID_LISTENER_FIELD(2, count),
	RAID_LISTENER_FIELD(2, window), RAID_LISTENER_FIELD(2, cooldown), RAID_LISTENER_FIELD(2, once), RAID_LISTENER_FIELD(2, consume),
	RAID_LISTENER_FIELD(2, dedupe), RAID_LISTENER_FIELD(2, emit),
	RAID_LISTENER_FIELD(3, event), RAID_LISTENER_FIELD(3, action), RAID_LISTENER_FIELD(3, source), RAID_LISTENER_FIELD(3, subject),
	RAID_LISTENER_FIELD(3, tag), RAID_LISTENER_FIELD(3, radius), RAID_LISTENER_FIELD(3, edge), RAID_LISTENER_FIELD(3, count),
	RAID_LISTENER_FIELD(3, window), RAID_LISTENER_FIELD(3, cooldown), RAID_LISTENER_FIELD(3, once), RAID_LISTENER_FIELD(3, consume),
	RAID_LISTENER_FIELD(3, dedupe), RAID_LISTENER_FIELD(3, emit),
	RAID_LISTENER_FIELD(4, event), RAID_LISTENER_FIELD(4, action), RAID_LISTENER_FIELD(4, source), RAID_LISTENER_FIELD(4, subject),
	RAID_LISTENER_FIELD(4, tag), RAID_LISTENER_FIELD(4, radius), RAID_LISTENER_FIELD(4, edge), RAID_LISTENER_FIELD(4, count),
	RAID_LISTENER_FIELD(4, window), RAID_LISTENER_FIELD(4, cooldown), RAID_LISTENER_FIELD(4, once), RAID_LISTENER_FIELD(4, consume),
	RAID_LISTENER_FIELD(4, dedupe), RAID_LISTENER_FIELD(4, emit),
#undef RAID_LISTENER_FIELD
